...
public class ProjectController {
	...
	public String homeProject(Model model, @Param("keyword")String keyword) {

		List<DisplayProject> listProjects=new ArrayList<DisplayProject>(); 
		System.out.println("Keyword "+ keyword);
		listProjects=customService.displayProject(keyword);
//		System.out.println("Size "+listProjects.size());
		ProcessDate.convertDate(listProjects);
